...
urlpatterns = [
    ...
    path('file-claim/<int:policy_record_id>/', views.file_claim_view, name='file-claim'),
    path('claim-status/', views.claim_status_view, name='claim-status'),
    path('admin-claims/', views.admin_claims_view, name='admin-claims'),
    path('process-claim/<int:claim_id>/', views.process_claim_view, name='process-claim'),
    path('process-claim-payment/<int:claim_id>/', views.process_claim_payment_view, name='process-claim-payment'),
    path('generate-receipt/<int:claim_id>/', views.generate_payment_receipt, name='generate-receipt'),

    path('apply/<int:policy_id>/', views.apply_policy_view, name='apply_policy'),

    path('renew-policy/<int:policy_record_id>/', views.renew_policy_view, name='renew-policy'),
    path('admin-renew-policy-status', views.admin_renew_policy_status_view, name='admin-renew-policy-status'),
    path('renew-policy/<int:policy_id>/', views.renew_policy_view, name='renew-policy'),
